...
# llamada de una funcion de separacion para que no este todo junto
def separacion():
    print("----------------------")
...
while True:
    ...
    #op==" lo hice asi por que es el unico que solo pide un dato si seleccionas este para que solo pida un dato
        ...
        # a qui es para los demas opciones para que pida sus dos datos
            ...
            valor2=float(input("Ingrese el segundo lado del cuadrado en cm: "))
        ...
        continue
    if op == 1:
        resultado=cuadrado(valor1,valor2)
